...
<!--  <label for="${AttributeConst.CUS_ADMIN_FLG.getValue()}">権限</label><br />
<select name="${AttributeConst.CUS_ADMIN_FLG.getValue()}" id="${AttributeConst.CUS_ADMIN_FLG.getValue()}">
    <option value="${AttributeConst.ROLE_GENERAL.getIntegerValue()}"<c:if test="${customer.adminFlag == AttributeConst.ROLE_GENERAL.getIntegerValue()}"> selected</c:if>>一般</option>
    <option value="${AttributeConst.ROLE_ADMIN.getIntegerValue()}"<c:if test="${customer.adminFlag == AttributeConst.ROLE_ADMIN.getIntegerValue()}"> selected</c:if>>管理者</option>
</select>
<br /><br /> -->
